...
export const BetaTestSection = () => {
  ...
  return (
    <>
      ...
      <section id="beta-test" className="relative py-40 overflow-hidden">
        ...
        <div ref={sectionRef} className="container mx-auto max-w-5xl relative z-10 opacity-0">
          ...
          <div className='flex justify-center mb-8  sm:mb-16'>
            <p className="py-2 px-4 text-red-300/70 leading-relaxed rounded-xl text-center text-sm sm:text-xl">
          ...
          {/* 하단 CTA */}
          <Link href="/memo">
            <button className="flex items-center justify-center py-3.5 px-6 sm:py-4 sm:px-8 mx-auto font-medium text-sm sm:text-base text-foreground transition duration-200 hover:text-foreground border border-primary hover:bg-black/50 hover:border-primary rounded-full shine-border">
              지금 무료로 시작하기
